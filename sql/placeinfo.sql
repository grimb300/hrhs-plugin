...
--
-- Host: localhost:3306
-- Generation Time: Apr 14, 2021 at 02:04 PM
...
CREATE TABLE `placeinfo` (
  ...
  `designator` varchar(12) NOT NULL DEFAULT '',
  `location` varchar(250) DEFAULT NULL,
  `remarks` varchar(250) DEFAULT NULL,
  `infosource` varchar(50) NOT NULL DEFAULT ''
...
INSERT INTO `placeinfo` (`placename`, `othername`, `designator`, `location`, `remarks`, `infosource`) VALUES
